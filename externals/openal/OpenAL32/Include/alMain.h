...
int OAL_pthread_key_create(pthread_key_t *key, void (*callback)(void*));
int OAL_pthread_key_delete(pthread_key_t key);
void *OAL_pthread_getspecific(pthread_key_t key);
int OAL_pthread_setspecific(pthread_key_t key, void *val);

#define OALInitializeCriticalSection InitializeCriticalSection
#define OALDeleteCriticalSection DeleteCriticalSection
#define OALEnterCriticalSection EnterCriticalSection
#define OALLeaveCriticalSection LeaveCriticalSection
...
void OAL_pthread_once(pthread_once_t *once, void (*callback)(void));

static __inline int OAL_sched_yield(void)
...
#define OAL_pthread_once pthread_once
#define OAL_pthread_key_create pthread_key_create
#define OAL_pthread_key_delete pthread_key_delete
#define OAL_pthread_getspecific pthread_getspecific
#define OAL_pthread_setspecific pthread_setspecific
#define OAL_sched_yield sched_yield

typedef pthread_mutex_t CRITICAL_SECTION;
void OALInitializeCriticalSection(CRITICAL_SECTION *cs);
void OALDeleteCriticalSection(CRITICAL_SECTION *cs);
void OALEnterCriticalSection(CRITICAL_SECTION *cs);
void OALLeaveCriticalSection(CRITICAL_SECTION *cs);
